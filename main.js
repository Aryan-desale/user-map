...
const search = instantsearch({
    indexName: 'user_info',
    searchClient: algoliasearch('NWDH5BRXYO', 'c2b0d7576ed869cc13d2ba024c1b6dcf'),
  });
...
mapboxgl.accessToken = 'pk.eyJ1IjoiYXJ5YW4wMDA3IiwiYSI6ImNrczA3YXR3cjFoOWwzMW83eGh5bndsMXUifQ.goNKVbDPWtlc4i4h-Imj1w';
...
let fakearr = [];
  ...
  for(let i= 0; i < userNameArr.length; i++) {
    ...
    fakearr[i] = new mapboxgl.Popup({ closeButton: false, closeOnClick: false })
